...
package object mathematica {
  implicit def bigDecimalToBigDecimalExpr(value: BigDecimal) = BigDecimalExpression(value)
  implicit def doubleToBigDecimalExpr(value: Double) = BigDecimalExpression(value)
